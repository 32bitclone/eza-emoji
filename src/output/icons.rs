...
impl Icons {
    ...
    const LANG_ASSEMBLY: char   = '\u{1f9e9}'; // 🧩
    ...
    const LANG_JAVASCRIPT: char = '\u{1f536}'; // 🔶
    ...
    const LANG_RUBY: char       = '\u{1f53b}'; // 🔻
    const LANG_RUBYRAILS: char  = '\u{1f53b}'; // 🔻
    ...
    const LANG_TYPESCRIPT: char = '\u{1f537}'; // 🔷
